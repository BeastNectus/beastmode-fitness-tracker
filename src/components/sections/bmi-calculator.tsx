      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.div
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-green-500/20 to-blue-500/20 backdrop-blur-sm border border-green-600 dark:border-green-500/30 text-gray-800 dark:text-white mb-8"
          >
          ...
          >
            <div className="glass-card rounded-3xl p-8 lg:p-12 neon-glow">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  <h3 className="text-2xl font-black text-gray-900 dark:text-white uppercase tracking-wider">BEAST CALCULATOR</h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    ...
                    <Input
                      ...
                      className="glass-card border-green-500/30 text-gray-900 dark:text-white text-xl py-6 rounded-2xl placeholder:text-gray-500 focus:border-green-400 focus:ring-green-400 bg-transparent"
                    />
                  </div>
                  <div className="space-y-3">
                    <label className="text-sm font-bold text-gray-900 dark:text-white uppercase tracking-wider flex items-center gap-2">
                    ...
                    <Input
                      ...
                      className="glass-card border-blue-500/30 text-gray-900 dark:text-white text-xl py-6 rounded-2xl placeholder:text-gray-500 focus:border-blue-400 focus:ring-blue-400 bg-transparent"
                    />
                  </div>
                </div>
          ...
          >
            <div className="glass-card rounded-3xl p-8 lg:p-12">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  <h3 className="text-2xl font-black text-gray-900 dark:text-white uppercase tracking-wider">BEAST LEVELS</h3>
