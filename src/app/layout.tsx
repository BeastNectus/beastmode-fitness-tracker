...
export const metadata: Metadata = {
  title: "Fitness Progress Tracker - Track Your Progress, Stay Motivated",
  ...
  keywords: "fitness tracker, progress tracking, BMI calculator, workout tracking, fitness app",
  authors: [{ name: "Fitness Progress Tracker" }],
  openGraph: {
    title: "Fitness Progress Tracker - Track Your Progress, Stay Motivated",
